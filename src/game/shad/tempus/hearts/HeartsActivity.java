    ...
    public void makeDeck() { 
		...
		for(int suit=0;suit<4;suit++){			
			for(int value=1;value<14;value++){
				...
				card cd = new card(x, y, value, suit, null);
...
/**
	...
	public void onPlayCardPressed(View v){
		if(cardToPlay!=null&&playing){ //make sure we have a card selected and we have not already played.
			...
			selectedCardTextBox.setText("You played the "+cardToString(cardToPlay));
	...
	public void playTwoOfClubs(){
		...
		setCardText(curPlayer, rs);//This advances the curPlayer.
		//test CODE TODO
	...
	public void onp1ClubsButtonPressed(View v){
		...
		selectedCardTextBox.setText(cardToString(cardToPlay));
	}
